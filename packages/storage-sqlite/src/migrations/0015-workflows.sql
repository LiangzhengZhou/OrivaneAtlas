...
CREATE TABLE workflow_activity (
 ...
 FOREIGN KEY(workspace_id,record_id) REFERENCES workflow_record(workspace_id,id),
...
CREATE TABLE workflow_outbox (
 ...
 PRIMARY KEY(workspace_id,record_id,version),
 FOREIGN KEY(workspace_id,record_id,version) REFERENCES workflow_activity(workspace_id,record_id,version)
) STRICT;
